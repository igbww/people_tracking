...
class PoseHighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.last_layer(x)
        # print("Final output feature map shape: ", x.shape)

        # 通过heads输出
        z = {}
        for head in self.heads:
            # the_head = self.__getattr__(head)
            # print(head, ":\n", the_head)
            # z[head] = the_head(x)
...
def get_pose_net(num_layers,
    ...
    """
    if num_layers == 32:
        cfg_dir = '/home/q116/anaconda3/envs/cndFairMOT/src/lib/models/networks/config/hrnet_w32.yaml'
    elif num_layers == 18:  # 18层的HRNet
        cfg_dir = '/home/q116/anaconda3/envs/cndFairMOT/src/lib/models/networks/config/hrnet_w18.yaml'
    else:
        cfg_dir = '/home/q116/anaconda3/envs/cndFairMOT/src/lib/models/networks/config/hrnet_w18.yaml'
